...
* [👋 Welcome to Mail Track for Gmail](README.md)
...
* [Installation](google-workspace-add-on/installation.md)
* [Send a tracked email](google-workspace-add-on/send-a-tracked-email.md)
* [Email tracking report](google-workspace-add-on/email-tracking-report.md)
* [Settings](google-workspace-add-on/settings.md)
